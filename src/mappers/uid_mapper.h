...
#ifndef __UID_MAPPER_H_
#define __UID_MAPPER_H_
...
#ifndef __UID_MAPPER_C_
#define UID_EXTERN extern
#else
#define UID_EXTERN
#endif
UID_EXTERN mapper_module * uid_mapper_module_init(scconf_block *blk,const char *mapper_name);
#undef UID_EXTERN
