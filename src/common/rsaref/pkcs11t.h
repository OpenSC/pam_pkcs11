...
#define CK_VENDOR_PKCS11_RU_TEAM_TC26 0xD4321000 /* 0x80000000 | 0x54321000 */
...
typedef CK_CALLBACK_FUNCTION(CK_RV, CK_NOTIFY) (CK_SESSION_HANDLE hSession,     /* the session's handle */
