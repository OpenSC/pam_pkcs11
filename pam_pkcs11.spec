...
License:        GPL
URL:            http://www.dit.upm.es/~jantonio/pam-pkcs11/
Source0: 	http://www.dit.upm.es/~jantonio/pam-pkcs11/downloads/pam_pkcs11-0.5.2.tar.gz
...
%files
%defattr(-,root,root,-)
%doc AUTHORS COPYING README TODO ChangeLog NEWS TODO
